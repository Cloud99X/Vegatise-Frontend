    ...
    <ScrollView style={styles.container}>
      ...
      <SafeAreaView>
        <View style={styles.border}>
          <Text style={styles.insuranceTeam}>Insurance Team</Text>
          <Text style={styles.insuranceNum}>Insurance number</Text>
          <Text style={styles.insuranceCode}>20023524545a</Text>
          <Text style={styles.imgTitle}>Image of the Insurance </Text>
          <View style={styles.section}>
            <View style={styles.imgBox}>
              <Image
                style={styles.img}
                source={require('../../assets/images/insuranceImg2.png')}
              />
            </View>
          </View>
        </View>
